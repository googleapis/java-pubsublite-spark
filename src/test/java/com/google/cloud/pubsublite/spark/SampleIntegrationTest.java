...
public class SampleIntegrationTest {
  ...
  private static void mavenPackage(String workingDir) {
    System.setProperty("maven.multiModuleProjectDirectory", workingDir);
    MavenCli mavenCli = new MavenCli();
    int mavenRes = mavenCli.doMain(
        new String[] {"clean", "package", "-Dmaven.test.skip=true"},
        workingDir,
        System.out,
        System.out);
    assertThat(mavenRes).isEqualTo(0);
  }
  ...
  public void test() throws Exception {
    ...
    ProjectId projectId = ProjectId.of("pubsub-lite-load-tests");
    TopicName topicName = TopicName.of("jiangmichael-sample-integration");
    ...
    SubscriptionPath subscriptionPath =
        SubscriptionPath.newBuilder()
            ...
            .build();
    String clusterName = "jiangmichael-psl-spark-connector-test-cluster-2";
    String bucketName = "jiangmichael-spark-sample-integration";
    ...
    String sampleJarLoc = String.format("%s/samples/snapshot/target/%s", workingDir, sampleJarName);
